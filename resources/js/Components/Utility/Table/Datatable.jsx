            ...
            <span className="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
                <nav aria-label="Table navigation">
                    <ul className="inline-flex items-center">
                        ...
                        <li>
                            <button
                                onClick={(e) => handlePageChange(nextPageUrl)}
...
const Datatable = ({
    ...
    const handleFilter = (e) => {
        ...
        timeOut = setTimeout(() => {
            Inertia.get(reqUrl, {},{ preserveState: true, preserveScroll: true });
    ...
    const handlePageChange = (url) => {
        Inertia.get(url + "&keyword=" +filterData.keyword, {},{ preserveScroll: true, preserveState: true });
    };

    const handlePaninateByPageNumber = (pageno) => {
        Inertia.get(data.first_page_url.replace("1", pageno)+ "&keyword=" +filterData.keyword, {}, {
            preserveScroll: true,
            preserveState: true,
        });
    };
